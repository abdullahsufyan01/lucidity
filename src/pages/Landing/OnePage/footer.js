...
// Import Images
import logolight from "../../../assets/images/Images Lucidity/Logo.png";
                    ...
                    <Row>
                        <Col lg={4} className="mt-4 fs-13">
                            <div>
                                ...
                                <div className="mt-4">
                                    <p>Empowering Your Business using Data Insights with Lucidity</p>
                                    <p className="ff-secondary">Unlock the Power of Customer Intelligence to Safeguard Your Retail Business</p>
                                </div>
                            </div>
                        </Col>
